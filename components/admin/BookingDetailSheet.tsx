...
export function BookingDetailSheet({
  ...
  function handleSaveNotes() {
    ...
    startTransition(async () => {
      ...
      if (result.success) setMessage({ type: 'success', text: 'Notat lagret.' })
      else setMessage({ type: 'error', text: result.error ?? 'Noe gikk galt.' })
      setActiveAction(null)
    })
  }
      ...
      <SheetContent className="w-full overflow-y-auto sm:max-w-xl">
        ...
        <Tabs defaultValue="detaljer">
          <TabsList className="mb-4 w-full">
            ...
            <TabsTrigger value="innsjekk" className="flex-1 gap-1">
            ...
            <TabsTrigger value="helse" className="flex-1 gap-1">
          ...
          {/* ── DETALJER TAB ─────────────────────────────────────────────── */}
          <TabsContent value="detaljer" className="space-y-5">
            {/* Status actions */}
          ...
          {/* ── INNSJEKK/UTSJEKK TAB ─────────────────────────────────────── */}
          <TabsContent value="innsjekk">
            {logsLoaded ? (
