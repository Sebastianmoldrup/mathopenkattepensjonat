        ...
        <div className="overflow-hidden rounded-xl border bg-white">
          ...
          <div className="border-b px-8 py-6">
            <p className="text-sm leading-relaxed text-slate-500">
              ...
              {', har en '}
              <span className="font-medium text-slate-700">reisejobb</span>{' '}
              eller er mye borte hjemmefra? Da vet vi hvor viktig det er å kunne
              reise med ro i hjertet — trygg på at katten din har det bra mens
              du er borte.
            </p>
